                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('Nouvelle facture proforma') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('prisechargeStore')}}" method="post" enctype="multipart/form-data">
                            @csrf
                             <div class="form-row">
                             <div class="col-md-4 form-group">
                               ...
                               <div class="col-md-4 form-group">
                                <label class="control-label" for="nom_medecin">Nom médecin</label>
                                 <input required type="text" name="nom_medecin" class="form-control form-control-alternative" id="hotital_centre" placeholder="Nom médecin">
                                 <div class="validate"></div>
                               </div>
                               <div class="col-md-4 form-group">
