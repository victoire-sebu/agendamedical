                            ...
                            @csrf
                             ...
                             <div class="col-md-4 form-group">
                                <label class="control-label" for="date_signature">Nom patient</label>
                                  <input type="text" name="nom_patient" class="form-control form-control-alternative" id="nom_patient" placeholder="Nom patient">
                                  <div class="validate"></div>
                             </div>
                               <div class="col-md-4 form-group">
                                <label class="control-label" for="date_signature">Hopital/Centre</label>
                                 <input type="text" name="hotital_centre" class="form-control form-control-alternative" id="hotital_centre" placeholder="Hopital/Centre">
                                 <div class="validate"></div>
                               </div>
                               <div class="col-md-4 form-group">
                                <label class="control-label" for="date_signature">Date signature</label>
                                <input type="date" class="form-control form-control-alternative" name="date_signature" id="email" placeholder="Date signature">
                               </div> 
                             </div>
