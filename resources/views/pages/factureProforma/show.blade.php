...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Information de la facture proformat'),
        'class' => 'col-lg-12'
    ])   
        ...
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4 ">
                        ...
                        <div class="text-center">
                            ...
                            <p>
                                <h3>Nom patient :</h3>
                                {{$factureProformas->nom_patient}}
                            </p>
                            <hr>
                            <p>
                                <h3> Hôpital / Centre</h3>
                                {{$factureProformas->hotital_centre}}
                            </p>
                            <hr>
                            <p>
                                <h3>Date de signature du document</h3>
                                {{$factureProformas->date_signature}}
                            </p>
                            <hr>
                            <p>
                                <h3>Date d'enregistrement du document dans l'application</h3>
                                {{$factureProformas->created_at}}
                            </p>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <img src="{{asset($factureProformas->image)}}" height="800px" width="600px" class="img-fluid"/>
                        <hr class="my-4" />
                    </div>
                </div>
            </div>
