...
@section('content')
    @include('users.partials.header', [
        ...
        'title' => __('Bon de sortie'),
        'description' => __('Information du bon du sortie'),
        'class' => 'col-lg-12'
    ])   
        ...
        <div class="row">
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <img src="{{asset($bonsorties->image)}}" height="800px" width="600px" class="img-fluid"/>
                        <hr class="my-4" />
                    </div>
                </div>
            </div>
